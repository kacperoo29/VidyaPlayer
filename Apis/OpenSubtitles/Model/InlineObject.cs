...
namespace OpenSubtitles.Model
{
    ...
    public partial class InlineObject :  IEquatable<InlineObject>, IValidatableObject
    {
        ...
        public InlineObject(string username = default(string), string password = default(string))
        {
            ...
            if (password == null)
            {
                throw new InvalidDataException("password is a required property for InlineObject and cannot be null");
            }
            else
            {
