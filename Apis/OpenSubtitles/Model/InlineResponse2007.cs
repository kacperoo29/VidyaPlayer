...
namespace OpenSubtitles.Model
{
    ...
    public partial class InlineResponse2007 :  IEquatable<InlineResponse2007>, IValidatableObject
    {
        ...
        public InlineResponse2007(decimal totalPages = default(decimal), decimal totalCount = default(decimal), decimal page = default(decimal), List<Subtitle> data = default(List<Subtitle>))
        {
            // to ensure "totalPages" is required (not null)
            if (totalPages == null)
            {
                throw new InvalidDataException("totalPages is a required property for InlineResponse2007 and cannot be null");
            }
            else
            {
            ...
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for InlineResponse2007 and cannot be null");
            }
            else
            {
            ...
            if (page == null)
            {
                throw new InvalidDataException("page is a required property for InlineResponse2007 and cannot be null");
            }
            else
            {
                this.Page = page;
