...
{
    /// <summary>
    /// InlineResponse2004AttributesFeatureDetails
    /// </summary>
    [DataContract]
    public partial class InlineResponse2004AttributesFeatureDetails :  IEquatable<InlineResponse2004AttributesFeatureDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2004AttributesFeatureDetails" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InlineResponse2004AttributesFeatureDetails() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse2004AttributesFeatureDetails" /> class.
        /// </summary>
        ...
        public InlineResponse2004AttributesFeatureDetails(decimal featureId = default(decimal), string featureType = default(string), decimal year = default(decimal), string title = default(string), string movieName = default(string), decimal imdbId = default(decimal), Object tmdbId = default(Object))
        {
            // to ensure "featureId" is required (not null)
            if (featureId == null)
            {
                throw new InvalidDataException("featureId is a required property for InlineResponse2004AttributesFeatureDetails and cannot be null");
            }
            else
            {
            ...
            if (featureType == null)
            {
                throw new InvalidDataException("featureType is a required property for InlineResponse2004AttributesFeatureDetails and cannot be null");
            }
            else
            {
            ...
            if (year == null)
            {
                throw new InvalidDataException("year is a required property for InlineResponse2004AttributesFeatureDetails and cannot be null");
            }
            else
            {
                this.Year = year;
            ...
            if (title == null)
            {
                throw new InvalidDataException("title is a required property for InlineResponse2004AttributesFeatureDetails and cannot be null");
            }
            else
            {
                this.Title = title;
            ...
            if (movieName == null)
            {
                throw new InvalidDataException("movieName is a required property for InlineResponse2004AttributesFeatureDetails and cannot be null");
            }
            else
            {
            ...
            if (imdbId == null)
            {
                throw new InvalidDataException("imdbId is a required property for InlineResponse2004AttributesFeatureDetails and cannot be null");
            }
            else
            {
                this.ImdbId = imdbId;
        ...
        /// Gets or Sets TmdbId
        /// </summary>
        [DataMember(Name="tmdb_id", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InlineResponse2004AttributesFeatureDetails {\n");
        ...
        {
            return this.Equals(input as InlineResponse2004AttributesFeatureDetails);
        }

        /// <summary>
        /// Returns true if InlineResponse2004AttributesFeatureDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse2004AttributesFeatureDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse2004AttributesFeatureDetails input)
        {
            if (input == null)
                return false;
